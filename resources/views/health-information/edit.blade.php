                ...
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6 text-right">
                            <a href="{{ route('user.show', $healthInformation->patient) }}" class="btn btn-sm btn-primary">{{ __('Cancel Edit') }}</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('health-information.update', $healthInformation) }}" autocomplete="off">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }} col-md-4 ">
                            ...
                            <div class="col-auto row">
                                <div class="custom-control custom-radio mb-3 col-md-3">
                                    <input name="gender" {{ $healthInformation->patient->gender == 'M' ? 'selected' : '' }} value="M" class="custom-control-input" id="customRadio1" checked="" type="radio">
                                    <label class="custom-control-label" for="customRadio1">Male</label>
                                </div>
                                <div class="custom-control custom-radio mb-3 col-md-3">
                                    <input name="gender" {{ $healthInformation->patient->gender == 'F' ? 'selected' : '' }} value="F" class="custom-control-input" id="customRadio2" type="radio">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }} col-md-4">
                            ...
                            <input type="text" name="weight" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Weight (kg)') }}" value="{{ old('weight', optional($healthInformation->patient->healthInformation)->weight) }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }} col-md-4">
                            ...
                            <input type="text" name="height" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Height (cm)') }}" value="{{ old('height', optional($healthInformation->patient->healthInformation)->height) }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }} col-md-4">
                            ...
                            <input type="text" name="hdlc" id="input-name" class="form-control form-control-alternative{{ $errors->has('hdlc') ? ' is-invalid' : '' }}" placeholder="{{ __('Cholesterol (mmol/L)') }}" value="{{ old('hdlc', optional($healthInformation->patient->healthInformation)->hdlc) }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }} col-md-4">
                            ...
                            <input type="text" name="blood_pressure" id="input-name" class="form-control form-control-alternative{{ $errors->has('blood_pressure') ? ' is-invalid' : '' }}" placeholder="{{ __('Blood Pressure (mmHg)') }}" value="{{ old('blood_pressure', optional($healthInformation->patient->healthInformation)->blood_pressure) }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }} col-md-4 ">
                            ...
                            <div class="col-auto row">
                                <div class="custom-control custom-radio mb-3 col-md-3">
                                    <input name="treatment" {{ optional($healthInformation->patient->healthInformation)->treatment == "1" ? 'checked' : '' }} value="1" class="custom-control-input" id="customRadio3" type="radio">
                                    <label class="custom-control-label" for="customRadio3">Yes</label>
                                </div>
                                <div class="custom-control custom-radio mb-3 col-md-3">
                                    <input name="treatment" {{ optional($healthInformation->patient->healthInformation)->treatment == "0" ? 'checked' : '' }} value="0" class="custom-control-input" id="customRadio4" type="radio">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }} col-md-4">
                            ...
                            <input type="text" name="total_cholesterol" id="input-name" class="form-control form-control-alternative{{ $errors->has('total_cholesterol') ? ' is-invalid' : '' }}" placeholder="{{ __('Cholesterol (mmol/L)') }}" value="{{ old('total_cholesterol', optional($healthInformation->patient->healthInformation)->total_cholesterol) }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }} col-md-4 ">
                            ...
                            <div class="col-auto row">
                                <div class="custom-control custom-radio mb-3 col-md-3">
                                    <input name="diabetes" {{ optional($healthInformation)->diabetes == '1' ? 'checked' : '' }} value="1" class="custom-control-input" id="customRadio5" type="radio">
                                    <label class="custom-control-label" for="customRadio5">Yes</label>
                                </div>
                                <div class="custom-control custom-radio mb-3 col-md-3">
                                    <input name="diabetes" {{ optional($healthInformation)->diabetes == '0' ? 'checked' : '' }} value="0" class="custom-control-input" id="customRadio6" type="radio">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }} col-md-4 ">
                            ...
                            <div class="col-auto row">
                                <div class="custom-control custom-radio mb-3 col-md-3">
                                    <input name="smoker" {{ optional($healthInformation)->smoker == '1' ? 'checked' : '' }} value="1" class="custom-control-input" id="customRadio7" type="radio">
                                    <label class="custom-control-label" for="customRadio7">Yes</label>
                                </div>
                                <div class="custom-control custom-radio mb-3 col-md-3">
                                    <input name="smoker" {{ optional($healthInformation)->smoker == '0' ? 'checked' : '' }} value="0" class="custom-control-input" id="customRadio8" type="radio">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }} col-md-4">
                            ...
                            <textarea name="family_history" class="form-control form-control-alternative" rows="3" placeholder="Write a brief about family history...">{{ optional($healthInformation)->family_history }}</textarea>
                        </div>

                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }} col-md-4">
                            <label class="form-control-label" for="input-name">{{ __('Medical History') }}</label>
                            <textarea name="medical_history" class="form-control form-control-alternative" rows="3" placeholder="Write a brief about medical history...">{{ optional($healthInformation)->medical_history }}</textarea>
                        </div>
